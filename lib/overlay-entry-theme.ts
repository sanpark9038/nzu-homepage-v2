...
export const ET = {
  ...
  // 에이스·슈에 — 샴페인 골드는 글자·라인에만 얹고 배경은 웜 뉴트럴 다크로.
  // 배경 자체를 어두운 노랑으로 깔면 갈색으로 보임(2026-07-18 사용자 피드백)
  aceBg:     "rgba(24, 22, 28, 0.90)",   // 스코어보드 에이스 칼럼 배경
  aceHeader: "linear-gradient(180deg, rgba(58,54,48,0.94), rgba(30,28,26,0.94))",
  aceTopHighlight: "inset 0 1px 0 rgba(242,220,160,0.20)",
