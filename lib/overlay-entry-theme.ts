...
export const ET = {
  ...
  // 입체감은 톤 그라디언트 + 윗면 헤어라인으로 충분 (방사형 조명은 장식이라 뺌)
  boardHeader: "linear-gradient(180deg, rgba(30,38,58,0.94), rgba(16,20,34,0.94))",
  header:      "linear-gradient(180deg, rgba(26,31,46,0.90), rgba(18,21,32,0.90))",
