...
function formatMatchStatus(match: PredictionMatch, nowMs: number) {
          ...
          >
            ...
            <div className="grid gap-3 p-4 lg:grid-cols-[minmax(0,1fr)_300px_minmax(0,1fr)] lg:items-stretch">
              <PickButton
                ...
                canVote={canVote}
                busy={busyKey !== null}
                onPick={() => void submitVote(match.id, match.teamA.teamCode)}
              />
              ...
              <PickButton
                ...
                canVote={canVote}
                busy={busyKey !== null}
                onPick={() => void submitVote(match.id, match.teamB.teamCode)}
              />
            </div>
